...
const Hero: React.FC<HeroProps> = ({ onOpenAssessment }) => {
  return (
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button onClick={onOpenAssessment} className="group relative px-8 py-4 bg-slate-900 text-white font-medium rounded-lg overflow-hidden transition-all hover:shadow-2xl hover:-translate-y-1">
